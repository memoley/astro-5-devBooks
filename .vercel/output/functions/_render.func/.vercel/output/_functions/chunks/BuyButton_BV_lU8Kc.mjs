import { c as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, a as renderComponent, d as createAstro } from './astro/server_DJTB-0-U.mjs';
import 'kleur/colors';
import 'clsx';
...
}, "C:/Users/memol/Documents/Desarrollo/dev-books/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  const storeCountry = country === SPAIN ? "mexico" : "spain";
  const countryName = country === SPAIN ? "M\xE9xico" : "Espa\xF1a";
...
}, "C:/Users/memol/Documents/Desarrollo/dev-books/src/components/BuyButton.astro", void 0);

const $$file = "C:/Users/memol/Documents/Desarrollo/dev-books/src/components/BuyButton.astro";
const $$url = undefined;
